...
interface IProps {
    ...
    penumpangValue: string;
    penumpangChange: (text: string)=> void;
}
export const SandarPriceInput = (props: IProps) => {
    return(
        <div className="sm:grid col-span-2">
            <SelectBox
                label="Jenis Penumpang / Barang"
            ...
            <PriceInput 
                disabled={false}
                label="Jumlah Penumpang / Barang"
                placeholder="Masukkan jumlah penumpang / barang"
                value={props.penumpangValue === "0" || props.penumpangValue == null || props.penumpangValue == undefined ? "" : props.penumpangValue}
                onChangeText={props.penumpangChange}
            />
