...
import { createNahkodaAction, editNahkodaAction, getDetailNahkodaAction, getKecakapanNahkodaAction } from "../nahkoda.service";

export default function EditNahkoda(){
                ...
                getDetailNahkodaAction(
                    ...
                    (data)=>{
                        ...
                        setSelectedKecakapan({
                            value: `${data.id_kecakapan}`,
                            label: data.nama_kecakapan
                        });
                        setStatus({
                            value: `${data.status_nahkoda}`,
                            label: data.status_nahkoda == 1 ? 'Aktif' : 'Tidak Aktif'
                        });
                        setLoading(false);
                    },
                    ()=>{
    ...
    const save = () => {
        if (!namaNahkoda || !email || !noTelepon || !status) {
