            ...
            <div className="p-4">
                ...
                <div className="flex mt-4 justify-between">
                    <div className="flex">
                        ...
                        <div className="ml-3">
                            <div className="text-xs font-robotoregular">Tersedia</div>
                            <div className="text-sm font-robotomedium">{props.jadwal.sisa_kursi}</div>
                        </div>
                    </div>
                    <div className="ml-3">
                        <div className="text-xs font-robotoregular">Kapasitas</div>
                        <div className="text-sm font-robotomedium">{props.jadwal.kapasitas_penumpang}</div>
                    </div>
                </div>
            </div>
        </div>
